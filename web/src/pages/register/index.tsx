...
import { Row, Col, Form, Input, Image, Button, Alert } from 'antd';
                ...
                <Header style={{ background: "#fff" }}>
                    <Row>
                        <Col xs={{ span: 2 }} md={{ span: 8 }}>
                            <Button onClick={() => history("/")}><LeftOutlined />Back</Button>
                        </Col>
                        <Col xs={{ span: 4, offset: 6 }} md={{ span: 8, offset: 8 }} style={{ textAlign: "end" }}>
                            <Button><Link to="/login">Already have an account? Log In</Link></Button>
                        </Col>
                    </Row>
                </Header>
                <Content>
