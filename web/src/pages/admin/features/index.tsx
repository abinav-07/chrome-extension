...
import { Button, Col, Form, Input, InputNumber, Layout, Modal, Popconfirm, Row, Select, Table, Tag, Typography, message } from 'antd';
import { useMutation, useQuery } from 'react-query';
import { createFeatures, createUserFeatures, fetchFeatures, updateFeatures } from '../../../services';
...
const FeatureList: React.FC = () => {
    ...
    // Create New Features Mutation
    const { mutate: createUserFeature, isLoading: createUserFeatureLoading } = useMutation(createUserFeatures, {
        onSuccess: () => {
                ...
                <Header style={{ background: "#fff" }}>
                    <Row>
                        ...
                        <Col span={1} offset={1} style={{ textAlign: "end" }}>
                            <Button onClick={() => setUserFeatureOpenModal(true)}>
